...
let package = Package(
    ...
    dependencies: [
        ...
        // TODO: revert to version when https://github.com/pointfreeco/swift-parsing/pull/289 gets merged
        .package(url: "https://github.com/pointfreeco/swift-url-routing.git", branch: "swift-5-8"),
...
extension Target {
    ...
    static let quizFeature: Target = .target(
        "QuizFeature",
        [.tca, .overture] + modules(.models, .styling, .quizClient, .logging)
    )
